...
function App() {
  ...
  return (
    <div className="App">
       <div className="app_videos">
        <Video channel="Lalala" description="This is a description" song="Taki Taki" likes={100} shares={200}messages={300}/>
     <Video channel="Salena" description="This is a description" song="Who Says" likes={500} shares={400}messages={700}/>
       </div>
    </div>
  );
} 
